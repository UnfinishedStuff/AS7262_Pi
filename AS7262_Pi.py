...
class AS7262():
    ...
    def __init__ (self):
        ...
        set_led_current(0)
        set_indicator_current(0)
        set_gain(3)
        set_integration_time(50)
    ...
    def get_calibrated_values():
        ...
        v = [colour_bytes[0], colour_bytes[1], colour_bytes[2], colour_bytes[3]]
        b = [colour_bytes[4], colour_bytes[5], colour_bytes[6], colour_bytes[7]]
        g = [colour_bytes[8], colour_bytes[9], colour_bytes[10], colour_bytes[11]]
        y = [colour_bytes[12], colour_bytes[13], colour_bytes[14], colour_bytes[15]]
        o = [colour_bytes[16], colour_bytes[17], colour_bytes[18], colour_bytes[19]]
        r = [colour_bytes[20], colour_bytes[21], colour_bytes[22], colour_bytes[23]]
